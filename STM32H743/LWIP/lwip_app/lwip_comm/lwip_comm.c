...
//      3,网卡添加失败.
/*
* this function is different with lwip_comm_init_ethernet
* tcpip_input use for netif_add
* 
*/
...
/***************************************************************************/
/****the following is used to get the DHCP fast*****************************/
/***************************************************************************/
 
/**
* this function use ethernet_input to netif_add() 
*
*/
u8 lwip_comm_init_ethernet(void)
{
    u8 retry=0;
	struct netif *Netif_Init_Flag;		//调用netif_add()函数时的返回值,用于判断网络初始化是否成功
	struct ip_addr ipaddr;  			//ip地址
