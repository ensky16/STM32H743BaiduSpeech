...
{
	$utf08Result= $response['result'][0];
	echo "asr UTF8Result is ". $utf08Result . "\r\n";
	echo "asr GBKResult is ";
	echo iconv("UTF-8","gbk//TRANSLIT",$utf08Result); //将字符串的编码从UTF-8转到GB2312
}else{
	//echo "asr has error\n";
}
...
//echo iconv("UTF-8","gbk//TRANSLIT",$res);
?>
